...
[![Tests](https://img.shields.io/badge/tests-550%20passing-brightgreen.svg)](#testing)
...
**Current test coverage:** 550 tests across all components
- 115 lexer tests
- 11 lexer unit tests
- 255 parser tests
- 8 type system unit tests
- 161 semantic analysis tests:
  - 28 analyzer tests
